...
| -------------- | ---------------------------------- | ------------------------------------------------------------ |
| includeMetrics | optional                           | boolean, if set to true, response will include usage metrics |
...
| increment      | required if includeMetrics is true | number, increment for data points in seconds                 |
